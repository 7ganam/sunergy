...
const events = [
  ...
  {
    name: "Whitepaper Launch: Cleantech Landscape in the Middle East",
    url: "https://www.youtube.com/watch?v=As9lJ0dcXFk&t=39s  ",
    image: "/pdfs/W.png",
  },
];
    ...
    <Layout>
      <section className="relative -mt-24 pt-24">
        <div className="relative isolate overflow-hidden pt-14">
          <img
            src="/assets/imgs/about/activity-header.jpg"
            alt=""
      ...
      <section id={"publications"} className="bg-slate-100 pb-5">
        ...
        <div
          className={"flex justify-center gap-5 max-w-[100%]  flex-wrap  pb-20"}
        >
      ...
      <section id={"events"} className=" pb-20">
        ...
        <div className="flex gap-5  justify-center max-w-[100%] flex-wrap  pb-20">
          <div className={"flex justify-center gap-5"}>
            <DocumentView publication={events[0]} />
          </div>
          <div className={"flex justify-center gap-5"}>
            <DocumentView publication={events[1]} isPdf={false} />
          </div>
        </div>
      </section>
    </Layout>
