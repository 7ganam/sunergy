            ...
            <div className="flex max-w-md mx-auto flex-col text-center">
              <div className="mt-12 mb-8 p-8 bg-white rounded shadow">
                ...
                <div className="flex mb-4 px-4 bg-slate-50 rounded border border-gray-200">
                  <input
                    className="w-full py-4 text-xs placeholder-slate-400 font-semibold leading-none bg-slate-50 outline-none"
                    type="email"
                ...
                <p className="my-6 text-xs text-slate-400 text-center font-semibold">
                  or continue with
                </p>
                <button
                  className="transition duration-300 ease-in-out transform hover:-translate-y-1 flex items-center w-full px-4 py-3 mb-2 text-xs text-slate-500 font-semibold leading-none border border-gray-200 hover:bg-slate-50 rounded"
                  href="#"
                >
                  <img
                    className="h-6 pr-10"
                ...
                <button
                  className="transition duration-300 ease-in-out transform hover:-translate-y-1 flex items-center px-4 py-3 w-full text-xs text-slate-500 font-semibold leading-none border border-gray-200 hover:bg-slate-50 rounded"
                  href="#"
                >
                  <img
                    className="h-6 pr-10"
              ...
              <div>
                <p className="text-xs text-slate-400 text-center">
                  <a className="underline hover:text-slate-500" href="#">
                    Police privacy
                  </a>{" "}
                  and{" "}
                  <a className="underline hover:text-slate-500" href="#">
