      ...
      <Layout>
        <section className="pt-20 pb-32">
          <div className="container text-center">
            ...
            <p
              className="mb-6 text-slate-400 wow animate__animated animate__fadeIn"
              data-wow-delay=".4s"
            >
            ...
            <div>
              ...
              <Link href="/contact" legacyBehavior>
                <a
                  className="block sm:inline-block py-4 px-8 text-xs text-slate-500 hover:text-slate-800 text-center font-semibold leading-none bg-slate-50 hover:bg-slate-100 rounded wow animate__animated animate__fadeIn"
                  data-wow-delay=".6s"
                >
                  Contact Us
                </a>
