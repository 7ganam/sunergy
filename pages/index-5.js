            ...
            <div className="mt-12 mb-12">
              ...
              <div className="max-w-2xl mx-auto text-center">
                <div className="flex flex-wrap">
                  <div className="flex flex-1 mb-4 mr-4 px-4 rounded bg-slate-50">
                    <svg
                  ...
                  <div className="flex flex-1 mb-4 lg:mr-4 px-4 rounded bg-slate-50">
                    <svg
                      className="h-6 w-6 my-auto mr-4"
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 20 20"
            ...
            <div className="flex flex-wrap">
              <div className="w-full md:w-1/2 px-3 order-1 md:order-0">
                <div className="max-w-md">
                  ...
                  <p
                    className="mb-6 leading-loose text-slate-400 wow animate__animated animate__fadeIn"
                    data-wow-delay=".5s"
                  >
          ...
          <div className="container">
            <div className="max-w-2xl mx-auto text-center">
              <div className="max-w-md mb-8 mx-auto">
                <span
                  className="text-sm text-slate-400 wow animate__animated animate__fadeIn"
                  data-wow-delay=".1s"
                >
                  Contact Us
                </span>
            ...
            <div className="flex flex-wrap">
              ...
              >
                <div className="px-6 py-10 bg-white shadow rounded">
                  ...
                  <p className="leading-loose text-slate-400 mb-5 text-sm">
