        ...
        <section className="relative -mt-24 pt-24">
          ...
          <div className="container">
            <div className="flex flex-wrap items-center -mx-3">
                ...
                <div className="py-12">
                  ...
                  <div className="text-center lg:text-left">
                    ...
                    <Link href="/services" legacyBehavior>
                      <a
                        className="block hover-up-2 sm:inline-block py-4 px-8 text-xs text-slate-500 hover:text-slate-600 text-center font-semibold leading-none bg-white border border-slate-200 hover:border-slate-300 rounded wow animate__animatedanimated animate__fadeIn"
                        data-wow-delay=".3s"
                      >
                        Our Services
                      </a>
              ...
              <div className="w-full lg:w-1/2 px-3 lg:bg-slate-10 mb-12 lg:mb-0 pb-10">
          ...
          <div className="container">
            <div className="flex flex-wrap justify-between pt-8 pb-16">
              <div
                ...
                data-wow-delay=".2s"
              >
                <div className="flex justify-center items-center bg-slate-50 text-blue-500 rounded-xl h-12 w-12 sm:h-24 sm:w-24">
                  <svg
                    className="w-8 h-8"
                    fill="none"
                    stroke="currentColor"
            ...
            <div className="flex flex-wrap -mx-3">
              <div className="w-full md:w-1/2 lg:w-1/3 px-3 mb-6">
                ...
                >
                  ...
                  <p className="mt-2 mb-8 text-slate-400">user per month</p>
                  ...
                  <div>
                    ...
                    <a
                      className="block sm:inline-block py-4 px-6 text-xs text-slate-500 hover:text-slate-600 text-center font-semibold leading-none bg-white border border-slate-200 hover:border-slate-300 rounded"
                      href="#"
                    >
                      Purchase
                    </a>
              ...
              <div className="w-full md:w-1/2 lg:w-1/3 px-3 mb-6">
                ...
                >
                  ...
                  <div>
                    <a
                      className="block sm:inline-block py-4 px-6 mb-4 sm:mb-0 sm:mr-3 text-xs text-blue-500 font-semibold leading-none bg-white hover:bg-slate-50 rounded"
                      href="#"
                    >
                      Start Free Trial
                    </a>
        ...
        <section className="py-20">
          <div className="container">
            <div className="max-w-lg mb-16">
              ...
              <p
                className="text-base lg:text-lg text-slate-400 wow animate__animatedanimated animate__fadeIn"
                data-wow-delay=".3s"
              >
                  ...
                  <div className="w-full lg:w-4/6 mb-6 lg:mb-0 px-3">
                    ...
                    <ul className="flex flex-col lg:flex-row justify-start space-y-2 lg:space-y-0 lg:space-x-8">
                      <li className="flex">
                        ...
                        <span className="text-slate-400">12 Emails</span>
                      </li>
                      <li className="flex">
                        <svg
                          className="h-6 w-6 mr-2 text-green-600"
                        ...
                        <span className="text-slate-400">8 Datebase</span>
                      </li>
                      <li className="flex">
                        <svg
                          className="h-6 w-6 mr-2 text-green-600"
                      ...
                      <li className="flex">
                        ...
                        <span className="text-slate-400">50 GB Storage</span>
                      </li>
                    </ul>
                  </div>
                  <div className="w-full lg:w-1/6 self-center text-xs px-3">
                    <a
                      className="block mb-2 py-4 text-center hover:text-white font-semibold bg-slate-200 hover:bg-blue-500 rounded"
                      href="#"
                    >
                      Buy 25$
                    </a>
                    <p className="text-center text-slate-400">per month</p>
                  </div>
                </div>
              </div>
              <div className="border-b border-gray-200">
              ...
              <div>
                <form>
                  ...
                  <div
                    ...
                    data-wow-delay=".3s"
                  >
                    <label className="flex px-2 bg-slate-50 rounded">
                      <input
                        className="hidden"
                        type="file"
                        name="Choose file"
                      />
                      <span className="my-1 ml-auto px-4 py-3 text-xs text-white font-semibold leading-none bg-slate-500 hover:bg-slate-600 rounded cursor-pointer">
                        {" "}
                        Browse
                      </span>
                    </label>
          ...
          <div className="container">
            <div className="max-w-2xl lg:max-w-3xl mx-auto">
              <div className="mb-12 text-center">
                ...
                <p
                  className="text-slate-400 wow animate__animatedanimated animate__fadeIn animated"
                  data-wow-delay=".5s"
                >
