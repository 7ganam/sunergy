...
const data = [
  {
    ...
    image: "/assets/imgs/services/f1.png",
    points: [
      "Evaluate readiness and maturity",
      "Assess applicability to market",
  ...
  },
  {
    ...
    image: "/assets/imgs/services/f2.png",

    points: [
      "Conduct comprehensive due diligence",
      "Evaluate strengths, weaknesses, and risks",
      "Assess value and potential in MENA",
    ],
  },
  {
    id: 3,
    title: "Technology Commercialization",
    image: "/assets/imgs/services/f3.png",
    points: [
          ...
          <div className="container">
            <div className="text-center mb-16">
              ...
              >
                ...
                <span className="text-cyan-500"> ASSESSMENT </span>
              </h2>
              <p
