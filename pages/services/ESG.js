...
const data = [
  {
    id: 1,
    title: "Support ESG Initiatives",
    image: "/assets/imgs/services/c1.png",
    points: [
  ...
  {
    id: 2,
    title: "ESG Performance Measurement and Reporting",
    image: "/assets/imgs/services/c2.png",

    points: [
      "Develop ESG performance metrics.",
      "Collect and analyze ESG data",
      "Prepare ESG reports and disclosures",
    ],
  },
  {
    id: 3,
    title: "Prioritize Sustainability Issues",
    image: "/assets/imgs/services/c3.png",
    points: [
      "GHG emissions reduction",
      "Define net zero carbon target road map",
