          ...
          <div className="container">
            <div className="py-12 text-center">
              ...
              <div>
                ...
                <a
                  className="tracking-wide hover-up-2 block sm:inline-block py-4 px-8 text-xs text-slate-500 hover:text-slate-600 text-center font-semibold leading-none bg-white rounded wow animate__animated animate__fadeIn"
                  data-wow-delay=".3s"
                  href="#how-we-work"
                >
                  How We Work?
          ...
          <div className="container">
            <div className="flex flex-wrap items-center justify-between max-w-2xl lg:max-w-full mb-12">
              ...
              <div className="w-full lg:w-1/2">
                <p className="text-slate-400 leading-loose wow animate__animated animate__fadeIn">
            ...
            <div className="flex flex-wrap bg-white rounded shadow wow animate__animated animate__fadeIn animated">
              <div className="w-full md:w-1/2 lg:w-2/5 px-3">
                <div className="p-8 text-center">
                  ...
                  <div className="flex mb-4 px-4 bg-slate-100 rounded">
                    <input
                      className="w-full py-4 text-xs placeholder-slate-400 font-semibold leading-none bg-slate-100 outline-none"
                      type="email"
                      placeholder="name@email.com"
                    />
                    <svg
                      className="h-6 w-6 ml-4 my-auto text-slate-300"
                      xmlns="http://www.w3.org/2000/svg"
                      fill="none"
                      viewBox="0 0 24 24"
                      stroke="currentColor"
                  ...
                  <div className="flex mb-6 px-4 bg-slate-100 rounded">
                    <input
                      className="w-full py-4 text-xs placeholder-slate-400 font-semibold leading-none bg-slate-100 outline-none"
                      type="password"
                    ...
                    <button className="ml-4">
                      <svg
                        className="h-6 w-6 my-auto text-slate-300"
                        xmlns="http://www.w3.org/2000/svg"
                        fill="none"
                        viewBox="0 0 24 24"
                        stroke="currentColor"
