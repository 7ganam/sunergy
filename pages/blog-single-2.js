        ...
        <section className="pb-20">
            ...
            <div className="container">
              <div className="max-w-2xl mx-auto">
                ...
                <div className="flex justify-center mb-8">
                  ...
                  />
                  <div className="pl-4">
                    <p className="text-slate-500 mb-1">Alice Bradley</p>
          ...
          <div className="container">
            <div className="max-w-2xl mx-auto">
              ...
              <p
                className="mb-6 leading-loose text-slate-400 wow animate__animated animate__fadeIn animated"
                data-wow-delay=".1s"
              >
            ...
            <div className="max-w-2xl mx-auto">
              <p
                className="leading-loose text-slate-400 wow animate__animated animate__fadeIn animated"
                data-wow-delay=".1s"
              >
