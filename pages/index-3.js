            ...
            <div className="flex flex-wrap items-center -mx-3">
              <div className="w-full lg:w-2/5 px-3">
                ...
                <div className="text-center lg:text-left">
                  ...
                  <a
                    className="block sm:inline-block hover-up-2 py-4 px-8 text-xs text-slate-500 hover:text-slate-600 text-center font-semibold leading-none bg-white border border-slate-200 hover:border-slate-300 rounded wow animate__animated animate__fadeIn"
                    data-wow-delay=".3s"
                    href="#how-we-work"
                  >
                    How We Work?
        ...
        <section className="py-12 md:pt-20 md:pb-12" id="how-we-work">
          <div className="container">
            <div className="max-w-lg mx-auto mb-20 text-center">
              ...
              <h2
                className="my-3 text-3xl md:text-4xl text-slate-900 font-bold font-heading wow animate__animated animate__fadeIn"
                data-wow-delay="0"
              >
                Partner Company Business And Me Success Fully
              </h2>
              <p
                className="text-slate-400 wow animate__animated animate__fadeIn"
                data-wow-delay=".3s"
              >
        ...
        >
          <div className="container">
            <div className="max-w-lg mx-auto mb-12 text-center">
              ...
              <p
                className="text-slate-400 leading-loose wow animate__animated animate__fadeIn"
                data-wow-delay=".3s"
              >
          ...
          <div className="container">
            <div className="relative py-20 px-4 lg:p-20">
              <div className="max-w-lg mx-auto text-center">
                ...
                <p
                  className="mb-8 text-slate-400 wow animate__animated animate__fadeIn"
                  data-wow-delay=".3s"
                >
                ...
                >
                  <div className="flex w-full md:w-2/3 px-3 mb-3 md:mb-0 md:mr-6 bg-slate-100 rounded">
                    <svg
                      className="h-6 w-6 my-auto text-slate-500"
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 20 20"
                      fill="currentColor"
                    >
                    ...
                    <input
                      className="w-full pl-3 py-4 text-xs text-slate-400 font-semibold leading-none bg-slate-100 outline-none"
                      type="text"
