      ...
      >
        <div className="flex flex-wrap mb-12 lg:mb-20 -mx-3 text-center lg:text-left">
            ...
            <Link href="/" legacyBehavior>
              <a className="inline-block mx-auto lg:mx-0 text-3xl font-semibold leading-none">
                <img
                  ...
                  src="/assets/imgs/logos/Sunergy Advisory_White Logo.png"
                  alt="Sunergy"
                />
              </a>
            </Link>
          ...
          <div className="w-full lg:w-2/5 px-3 mb-8 lg:mb-0">
            <p className="max-w-md mx-auto lg:max-w-full lg:mx-0 lg:pr-32 lg:text-lg text-white leading-relaxed">
              Sunergy is a leading Clean Tech consulting and advisory firm based
              in the UAE that specializes in the clean energy and sustainability
              sectors in the
        ...
        <div className="flex flex-col lg:flex-row items-center lg:justify-between">
          ...
          <div className="order-first lg:order-last -mx-2 mb-4 lg:mb-0">
            ...
            <a
              className="inline-block px-2 h-2"
              href="https://www.youtube.com/channel/UCoMA2qHsasJw45kGim5ximg"
            >
